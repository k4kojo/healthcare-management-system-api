...
import { seedMedicationLogs } from "./medicationLogs.seed.js";
import { seedMedicationReminders } from "./medicationReminders.seed.js";
...
async function main() {
  ...
  try {
    ...
    const medications = await seedMedications(users, medicalRecords);
    const medicationLogs = await seedMedicationLogs(medications);
    const medicationReminders = await seedMedicationReminders(medications);
